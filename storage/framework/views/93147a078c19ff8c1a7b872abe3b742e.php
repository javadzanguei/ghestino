...
} elseif ($_instance->childHasBeenRendered('XmpZVa1')) {
    $componentId = $_instance->getRenderedChildComponentId('XmpZVa1');
    $componentTag = $_instance->getRenderedChildComponentTagName('XmpZVa1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XmpZVa1');
} else {
    $response = \Livewire\Livewire::mount('installment.calculator', []);
    $html = $response->html();
    $_instance->logRenderedChild('XmpZVa1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
} elseif ($_instance->childHasBeenRendered('JWvI0Vr')) {
    $componentId = $_instance->getRenderedChildComponentId('JWvI0Vr');
    $componentTag = $_instance->getRenderedChildComponentTagName('JWvI0Vr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JWvI0Vr');
} else {
    $response = \Livewire\Livewire::mount('installment.request', []);
    $html = $response->html();
    $_instance->logRenderedChild('JWvI0Vr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
