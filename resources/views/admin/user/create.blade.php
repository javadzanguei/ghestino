...
@section('content')
    <div class="pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2 fw-bold text-center">ثبت کاربر جدید</h1>
    </div>
    @if($errors->any())
        <div class="alert alert-danger pb-0 mb-2">
            <ul>
    ...
    @endif
    <form class="row g-3 px-3 needs-validation" method="post" action="{{ route('admin.user.store') }}">
        @csrf
        ...
        <div class="col-12 col-md-6 mb-3 form-floating">
            <input type="text" class="form-control @error('fullname') is-invalid @enderror" id="fullname"
                   ...
                   placeholder="نام کاربر" autocomplete="off">
        ...
        <div class="col-12 col-md-6 mb-3 form-floating">
            <input type="text" class="form-control @error('mobile') is-invalid @enderror" id="mobile" name="mobile"
                   ...
                   placeholder="تلفن کاربر" dir="ltr" autocomplete="off">
            <label for="mobile" class="form-label">موبایل کاربر</label>
            <div class="invalid-feedback">موبایل کاربر لطفا!</div>
        </div>
        <div class="col-12 col-md-6 mb-3 form-floating">
            <input type="text" class="form-control @error('password') is-invalid @enderror" id="password"
                   name="password" required
                   placeholder="کلمه عبور کاربر" dir="ltr" autocomplete="off">
            <label for="password" class="form-label">کلمه عبور کاربر</label>
        </div>
        <div class="col-12 col-md-6 mb-3 form-floating">
            <fieldset>
