...
/*!*****************************************!*\
  !*** ./resources/js/num2persian.min.js ***!
  \*****************************************/
/**
...
var delimiter = " و ",
  ...
  prepareNumber = function prepareNumber(e) {
    var t = e;
    return "number" == typeof t && (t = t.toString()), t.length % 3 == 1 ? t = "00".concat(t) : t.length % 3 == 2 && (t = "0".concat(t)), t.replace(/\d{3}(?=\d)/g, "$&*").split("*");
  },
  tinyNumToWord = function tinyNumToWord(e) {
