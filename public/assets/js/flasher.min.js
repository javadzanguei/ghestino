...
!function (e, t) {
  ...
  !function (n, r) {
    if (n && "undefined" != typeof document) {
      ...
      if (a) {
        var f = e.indexOf(l);
        -1 === f && (f = e.push(l) - 1, t[f] = {}), o = t[f] && t[f][i] ? t[f][i] : t[f][i] = s();
      } else o = s();
  ...
  var r = function () {
      ...
      return e.prototype.success = function (e, t, n) {
        ...
        if ("object" == _typeof(e) ? (e = (r = e).type, t = r.message, n = r.title) : "object" == _typeof(t) ? (t = (r = t).message, n = r.title) : "object" == _typeof(n) && (n = (r = n).title), void 0 === t) throw new Error("message option is required");
        return {
          type: e || "info",
          message: t,
          title: n,
        ...
        this.options = Object.assign({}, this.options, e), this.applyDarkMode();
        ...
        if (!document.body.classList.contains("fl-dark-mode")) {
          ...
          i.type = "text/css", i.appendChild(document.createTextNode(o)), document.head.appendChild(i), document.body.classList.add("fl-dark-mode");
        }
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/flasher.min.js");
/******/ 	
/******/ })()
;